...
| **3 — Cohort assignment** | A *developer of investable scale* on one of two tiers, who is still active (latest release < 5y). Excludes the AAA tier as out-of-scope. | Single-title devs, true-AAA studios, dormant devs (≥5y since latest release) | 6,835 devs / 27,866 titles (5,911 C1 + 924 C2) |
...
| **5 — PCI-resolvable** | A dev whose PCI is *meaningful* — at least 2 of their titles have measurable owners (>0 lower bound) | Devs whose entire catalog is in the 0-bucket, or who only have one measurable title | 1,612 devs / 10,538 titles |
| **6 — Quality cleanup** | Three audit-derived exclusion lists removed: (6a) port-shops / translators / VN repackagers, (6b) Round-1 shovelware, (6c) Round-2 high-volume low-engagement audit | Studios whose catalogs look concentrated only because they don't ship their own IP | **1,551 devs / 8,767 titles** |
| **7 — Moderate + concentrated** | The two PCI categories where investment economics make sense: a dev with 35%–85% of owners in their top title. Diversified studios behave like portfolios; one-hit studios are unrepeatable. | Diversified (PCI < 0.35) and one-hit (PCI ≥ 0.85) studios | 1,210 devs / 4,925 titles (649 C1 + 561 C2) |
...
| **11 — Investor candidates** | A developer who is **(a)** in C1 or C2 at investable scale, **(b)** focused (moderate/concentrated PCI), **(c)** clean on the suspect battery, and **(d)** showing positive momentum (RISING or ANCHOR_RECENT). | Falling, steady, mature, aging trajectories; anyone flagged on the suspect battery | **146 devs / 457 titles** (53 C1 + 93 C2) |
